...
async def main():
    ...
    if all_passed and any(r == "PASSED" for r in results.values()):
        ...
        print(f"   At least one provider working correctly")
        print(f"   Generated test documents saved for inspection")
        print(f"\n✅ Ready to build v3.6.0 frontend!")
        return 0
    else:
        print(f"\n⚠️  VALIDATION INCOMPLETE")
        print(f"   Please fix provider issues before building frontend")
        return 1
