...
const DocumentGenerationWizard = defineAsyncComponent(() => import('@/components/DocumentGenerationWizard.vue'))
const DocumentView = defineAsyncComponent(() => import('@/components/DocumentView.vue'))
const GenerationProgress = defineAsyncComponent(() => import('@/components/GenerationProgress.vue'))

// Import lighter components normally
...
const handleWizardGenerate = async (wizardData) => {
  // Transform wizard data to the format expected by the backend
  const formData = {
    ...wizardData.projectData,
    selectedDocuments: wizardData.selectedDocuments,
    generationOptions: wizardData.generationOptions
  }
...
const handleWizardCancel = () => {
  // Return to dashboard or show basic form
