#!/usr/bin/env python3
"""
Fix script for API integration issues in DevDocAI v3.0.0
This script creates corrected versions of the API endpoints
"""
...
async def enhance_document(request: EnhanceDocumentRequest):
    ...
    try:
        ...
        result = pipeline.enhance_document(
            ...
            document_type=request.strategy or "general"
        )
...
'''
    ...
    output_path = "/Users/etherealogic/Dev/DocDevAI-v3.0.0/devdocai-frontend/api/main_fixed.py"
...
if __name__ == "__main__":
    print("🔧 Creating fixed API integration...")
    fixed_path = create_fixed_main_py()

    print("\n📝 Next steps:")
    print("1. Review the fixed file")
    print("2. Backup the current main.py")
    print("3. Replace main.py with main_fixed.py")
