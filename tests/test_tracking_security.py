...
class TestAuditLogger:
    ...
    def test_operation_logging(self):
        ...
        audit.log_operation("add_document", user="test_user", details={"doc_id": "doc123"})
    ...
    def test_security_event_logging(self):
        ...
        audit.log_security_event(
            "authentication_failure", "high", {"ip": "192.168.1.1", "attempts": 3}
        )

        audit.log_security_event(
            "rate_limit_exceeded", "medium", {"operation": "api_call", "limit": 100}
        )
    ...
    def test_concurrent_logging(self):
        ...
        def log_operations(thread_id):
            for i in range(10):
                audit.log_operation(f"operation_{thread_id}_{i}", user=f"thread_{thread_id}")
...
class TestTrackingMatrixSecurity:
    ...
    def secure_matrix(self):
        ...
        config.get.return_value = {
            "security": {"enable_pii_detection": True, "cache_ttl_seconds": 300}
        }
    ...
    def test_secure_json_export(self, secure_matrix):
        ...
        secure_matrix.add_relationship("doc1", "doc2", RelationshipType.DEPENDS_ON)
...
class TestOWASPCompliance:
    ...
    def test_a09_logging_monitoring(self):
        ...
        audit.log_security_event("suspicious_activity", "high", {"details": "test"})
