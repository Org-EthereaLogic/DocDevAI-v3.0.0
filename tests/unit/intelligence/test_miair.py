...
class TestMIAIREngine:
    ...
    def test_optimize_reaches_quality_gate(self, engine, mock_llm):
        ...
        engine.measure_quality = Mock(side_effect=[
            DocumentMetrics(entropy=2.0, coherence=0.6, quality_score=score, 
                          word_count=10, unique_words=8)
    ...
    def test_optimize_max_iterations(self, engine, mock_llm):
        ...
        engine.measure_quality = Mock(return_value=DocumentMetrics(
            entropy=3.0, coherence=0.5, quality_score=60,
            word_count=10, unique_words=8
        ))
    ...
    def test_optimize_calculates_improvement_percentage(self, engine, mock_llm):
        ...
        engine.measure_quality = Mock(side_effect=[
            DocumentMetrics(entropy=3.0, coherence=0.5, quality_score=50,
                          word_count=10, unique_words=8),
            DocumentMetrics(entropy=1.5, coherence=0.95, quality_score=90,
                          word_count=15, unique_words=12)
        ])
