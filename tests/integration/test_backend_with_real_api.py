...
async def test_document_generator():
    ...
    try:
        ...
        document = await generator.generate_document(template_name="readme", context=context)
        ...
        print(
            f"   - Has AI-generated content: {'Yes' if 'TestProject' in document.content else 'No'}"
        )
