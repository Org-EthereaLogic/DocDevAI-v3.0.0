...
class TrackingMatrix:
    ...
    def add_relationship(self, source_id: str, target_id: str,
        ...
        try:
            if self._allow_cycles:
                ...
                rel = DocumentRelationship(source_id, target_id, 
                ...
                self.graph.add_edge(source_id, target_id, relationship_type, 
                                  strength, metadata)
    ...
    def import_from_json(self, json_data: str):
        ...
        logger.info(f"Imported {len(data.get('nodes', []))} documents and "
