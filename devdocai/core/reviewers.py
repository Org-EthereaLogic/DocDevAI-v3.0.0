...
from .review_patterns import (
    BaseReviewer as PatternBaseReviewer,
    QualityReviewer,
...
class RequirementsReviewer(PatternBaseReviewer):
    ...
    def __init__(self):
        ...
        self.ambiguous_phrases = [
            ...
            "user-friendly", "intuitive", "robust", "flexible",
            "scalable", "reliable", "secure", "easy"
        ]
    ...
    async def review(self, content: str, metadata: Dict[str, Any]) -> ReviewResult:
        ...
        ambiguous_count = sum(
            content.lower().count(phrase.lower())
        ...
        score = self.calculate_score(
            len(testable_matches) + (1 if rfc2119_compliance else 0),
            10
        )
...
class DesignReviewer(QualityReviewer):
    ...
    async def review(self, content: str, metadata: Dict[str, Any]) -> ReviewResult:
        ...
        has_diagrams = any(
            ...
            for indicator in ["diagram", "figure", "chart", "```mermaid"]
        )
...
class PerformanceReviewer(QualityReviewer):
    ...
    def __init__(self):
        ...
        self.performance_indicators = [
            ...
            "throughput", "benchmark", "cache", "async"
        ]
    ...
    async def review(self, content: str, metadata: Dict[str, Any]) -> ReviewResult:
        ...
        perf_mentions = self.pattern_matcher.count_occurrences(
            content,
            set(self.performance_indicators)
        )
...
class UsabilityReviewer(QualityReviewer):
    ...
    async def review(self, content: str, metadata: Dict[str, Any]) -> ReviewResult:
        ...
        score = readability * 0.5 + (0.3 if has_usability else 0.0) + (0.2 if has_accessibility else 0.0)
...
class CoverageReviewer(PatternBaseReviewer):
    ...
    async def review(self, content: str, metadata: Dict[str, Any]) -> ReviewResult:
        ...
        test_mentions = self.pattern_matcher.count_occurrences(
            content,
            set(self.test_keywords)
        )
