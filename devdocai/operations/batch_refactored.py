...
class BatchOperationsManager:
    ...
    def _init_processor(self):
        ...
        self.processor = DocumentProcessorFactory.create(
            self.config.processor_type
        )
    ...
    async def _execute_strategy(
        ...
        **kwargs
        ...
        for batch in batches:
            ...
            batch_results = await self.strategy.process(
                batch,
    ...
    async def _process_document(
        ...
        **kwargs
        ...
        if self.monitor:
            await self.monitor.record_document_start(
...
def create_batch_manager(
    ...
    **options
    ...
    if "enable_security" in options:
        builder.with_security(
            options["enable_security"],
            options.get("security_config")
        )
